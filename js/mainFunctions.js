...
window.addEventListener("load", function () {
    if (document.getElementById('insertMail')) {
        ...
        newAhref.href = "https://wa.me/5491138424123?text=Hola,%20me%20gustaría%20obtener%20información%20sobre%20la%20pastoral%20juvenil%20Huella%20Joven.%20Me%20contacto%20desde%20la%20web.";
        newAhref.innerHTML = 'WhatsApp Aquí';
...
// Locations
$(function () {
    $(".card").on('click', () => { window.location.href = "https://www.instagram.com/huellajoven.fe" });
})
// Location socials
$(function () {
    ...
    $('.instagram').on('click', function (event) {
        event.preventDefault();
        window.location.href = "https://www.instagram.com/huellajoven.fe";
    });
})
